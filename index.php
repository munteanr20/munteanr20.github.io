    ...
    <!-- <div class="container">
        ...
        <div id="carousel" class="carousel slide w-75 top" data-ride="carousel" data-interval="6500">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    <img src="img/carousel/1.3.jpg" alt="" class="w-100">
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-8 bg-custom d-none d-lg-block py-3 px-0">
                                    ...
                                    <a href="./Pagini/" class="btn btn-info btn-lg mr-2">Despre mine</a>
                                    <a href="#" class="btn btn-warning btn-lg ml-2">Contacteaza-ma</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="carousel-item">
                    <img src="img/carousel/1.2.jpg" alt="" class="w-100">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-end text-right">
                                <div class="col-5 bg-custom d-none d-lg-block py-3 px-0 pr-3">
                                    <p class="lead pb-3">Nimeni nu s-a nascut invatat, inca din 2016 experimentez si imi
                                        place ceea ce fac.</p>
                                    <a href="./Pagini/Despre.html" class="btn btn-info btn-lg">Despre mine</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="carousel-item">
                    <img src="img/carousel/1.1.jpg" alt="" class="w-100">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-start text-left">
                                <div class="col-4 bg-custom d-none d-lg-block py-3 px-0 pl-3">
                                    ...
                                    <a href="./Pagini/" class="btn btn-warning btn-lg">Proiecte</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container feedback">
            ...
            <div class="owl-carousel owl-theme pt-3">
                ...
                <div class="card pt-3 mx-auto">
                    <img class="card-img-top px-3" src="img/Poze/Dsc-17 (2).jpeg" alt="Card image cap">
                    <div class="card-body center">
                    <h5 class="card-title">Motto-ul meu în viață</h5>
                    <p class="card-text">"<i>Dacă lumea te vorbestepe la spate e limpede că tu ești în fața </i>😎"</p>
                ...
                <div class="card pt-3 mx-auto">
                    ...
                    <h5 class="card-title">Motto-ul meu în viață</h5>
                    <p class="card-text">"<i>Dacă lumea te vorbestepe la spate e limpede că tu ești în fața </i>😎"</p>
                    <p class="card-text-footer">Octavian <br>Rotila</p>
                    </div>
                </div>
        ...
        <div class="container my-5 bio">
            <div class="row py-4">
                ...
                <div class="col-lg-4 mb-4 my-lg-auto">
                    ...
                    <a href="./Proiecte/Despre.html" class="btn btn-outline-dark btn-lg">Mai multe</a>
                </div>
        ...
        <div class="container my-5 bio ">
            ...
            <div class="row my-4 center font-weight-bold black ">
                <div class="col-lg-3 col-md-5 col-sm-10 mx-3 my-3 portofoliu radius">
                    ...
                    <p class="pt-3">Ovidiu - baiat serios surprins cu un pahar de sange de taur in mana.</p>
                        <div class="overlay ">
                ...
                <div class="col-lg-3 col-md-5 col-sm-10 mx-3 my-3 portofoliu radius">
                    ...
                    <p class="pt-3">Stefan - considera ca mai bine calareste motorul decat o fata </p>
                    <div class="overlay">
                        <a href="#" class="btn btn-dark btn-lg">Vezi sedinta</a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-5 col-sm-10 mx-3 my-3 portofoliu radius" >
                    ...
                    <p class="pt-3">Gore - ardelean care zice ca nu e ardelean chiar daca face poza cu lime-ul.</p>
                    <div class="overlay">
                        <a href="#" class="btn btn-dark btn-lg">Vezi sedinta</a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-5 col-sm-10 mx-3 my-3 portofoliu radius"> 
                    ...
                    <p class="pt-3">Cosmin - baiat saritor, tot timpul are o cheie la el pentru cei incuiati la minte.</p>
                ...
                <div class="col-lg-3 col-md-5 col-sm-10 mx-3 my-3 portofoliu radius"> 
                    ...
                    <p class="pt-3">Iarna - un anotimp care nu a fost prezent in adevaratul sens al lui anul acesta.</p>
                    
                </div>
                <div class="col-lg-3 col-md-5 col-sm-10 mx-3 my-3 portofoliu radius"> 
                    <img class="w-100 mt-3 radius" src="img/Poze/Eu3.jpg">
                    <p class="pt-3">Eu - un urs in devenire care nu a mai prins sa se scalde la garla in viata lui.</p>
                    <div class="overlay">
                        <a href="#" class="btn btn-dark btn-lg">Vezi sedinta</a>
                    </div>
                </div>
        ...
        <div id="go-top-link"> 
            <a href="index.php" class="btn btn-dark btn-lg">
                <i class="fas fa-dragon" title="Mergi sus" aria-labe="Mergi sus"></i>
            </a>
        </div>
    <!-- End Bio-->
